...
<?php $__env->startSection('isihalaman'); ?>
    <h3><center>Daftar Anggota Perpustakaan ITS</center></h3>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formanggotaedit" id="formanggotaedit" action="/anggota/edit/<?php echo e($a->id_anggota); ?> " method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label for="id_anggota" class="col-sm-4 col-form-label">nrp</label>
                                                <div class="col-sm-8">
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Kuliah\Semester 5\Pemrograman Web\ETS\perpus\resources\views/halaman/view_anggota.blade.php ENDPATH**/ ?>